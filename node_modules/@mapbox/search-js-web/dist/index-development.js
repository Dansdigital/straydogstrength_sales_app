...
var parseExplicitOrIPProximity = (proximity, responseHeaders) => {
  if (typeof proximity === "string") {
    ...
    return import_search_js_core7.LngLat.convert(proximity).toArray();
  }
};
var transformSearchBoxAPIOptionsToEventSchema = (options) => {
  ...
  if (options.bbox) {
    if (typeof options.bbox === "string") {
      ...
      transformedOptions.bbox = import_search_js_core7.LngLatBounds.convert(options.bbox).toFlatArray();
    }
  }
...
var MapboxAddressAutofill = class extends HTMLScopedElement {
  constructor() {
    super(...arguments);
    __privateAdd(this, _autofill, new import_search_js_core8.AddressAutofillCore());
    __privateAdd(this, _session, new import_search_js_core8.SearchSession(__privateGet(this, _autofill)));
...
var MapboxSearchBox = class extends HTMLScopedElement {
  constructor() {
    ...
    __privateAdd(this, _search, new import_search_js_core9.SearchBoxCore({}));
    __privateAdd(this, _session2, new import_search_js_core9.SearchSession(__privateGet(this, _search)));
    ...
    __privateAdd(this, _handleRetrieve2, (result) => {
      ...
      const suggestion = (0, import_search_js_core9.featureToSuggestion)(featureCollection.features[0]);
      ...
      if (bounds) {
        map.flyTo(bboxViewport(map, import_search_js_core9.LngLatBounds.convert(bounds).toFlatArray()));
      } else {
    ...
    __privateAdd(this, _onHandleInput2, (e) => {
      ...
      __privateGet(this, _session2).suggest(searchText, __spreadValues(__spreadValues({}, this.options), this.componentOptions));
  ...
  attributeChangedCallback(name2, oldValue, newValue) {
    ...
    if (name2 === "allow-reverse") {
      this.componentOptions.allowReverse = newValue === "true";
      return;
    }
    if (name2 === "flip-coordinates") {
      this.componentOptions.flipCoordinates = newValue === "true";
      return;
    }
    const optionName = name2.split("-").join("_");
    if (!newValue) {
...
var import_subtag2 = __toESM(require("subtag"));
var MAX_ZOOM2 = 9;
...
var MapboxGeocoder = class extends HTMLScopedElement {
  constructor() {
    ...
    __privateAdd(this, _search2, new import_search_js_core10.GeocodingCore({}));
    __privateAdd(this, _session3, new import_search_js_core10.SearchSession(__privateGet(this, _search2)));
    ...
    __privateAdd(this, _handleRetrieve3, (result) => {
      ...
      const bounds = feature.properties.bbox;
      if (bounds) {
        map.flyTo(bboxViewport(map, import_search_js_core10.LngLatBounds.convert(bounds).toFlatArray()));
      } else {
        const center = feature.geometry.coordinates;
        const zoom = getMaxZoom(placeType);
        map.flyTo({
    ...
    __privateAdd(this, _onHandleInput3, (e) => {
      ...
      __privateGet(this, _session3).suggest(searchText, __spreadValues(__spreadValues({}, this.options), this.componentOptions));
...
var import_search_js_core11 = require("@mapbox/search-js-core");
...
var MapboxAddressMinimap = class extends HTMLScopedElement {
  constructor() {
    ...
    __privateAdd(this, _getImageUrl, (lngLatLike) => {
      ...
      let imgUrl = baseUrl + import_search_js_core11.LngLat.convert(lngLatLike).toArray().join(",") + "," + ZOOM + ",0/" + Math.min(__privateGet(this, _width) * 2, MAX_IMAGE_DIM) + "x" + Math.min(__privateGet(this, _height) * 2, MAX_IMAGE_DIM) + "?access_token=" + this.accessToken + "&attribution=false&logo=false";
...
// src/autofill.ts
var import_search_js_core12 = require("@mapbox/search-js-core");
...
var AddressAutofillInstance = class {
  constructor(collection, input, autofillRef) {
    ...
    __privateSet(this, _session4, new import_search_js_core12.SearchSession(autofillRef));
...
var AddressAutofillCollection = class extends import_search_js_core12.Evented {
  constructor({
    accessToken,
    options,
    theme,
    ...
    __privateAdd(this, _autofill2, new import_search_js_core12.AddressAutofillCore());
