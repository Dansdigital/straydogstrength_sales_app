...
<head>
    <title>Code coverage report for src/components/Geocoder.tsx</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../index.html">All files</a> / <a href="index.html">src/components</a> Geocoder.tsx</h1>
        <div class='clearfix'>
...
<a name='L360'></a><a href='#L360'>360</a></td><td class="line-coverage quiet"><span class="cline-any cline-yes">12x</span>
...
&nbsp;
/**
 * Methods available on a `ref` when attached to the {@link Geocoder} component.
...
&nbsp;
/**
 * Props for the {@link Geocoder} component
...
&nbsp;
    // Update options.
    useEffect(() =&gt; {
      if (ref.current) ref.current.options = options || <span class="branch-1 cbranch-no" title="branch not covered" >{};</span>
    }, [ref.current, options]);
&nbsp;
    // Update componentOptions.
    useEffect(() =&gt; {
      if (ref.current) ref.current.componentOptions = componentOptions || {};
...
&nbsp;</pre></td></tr></table></pre>
            ...
            <div class='footer quiet pad2 space-top1 center small'>
                ...
                at Wed May 21 2025 20:38:33 GMT-0700 (Pacific Daylight Time)
            </div>
