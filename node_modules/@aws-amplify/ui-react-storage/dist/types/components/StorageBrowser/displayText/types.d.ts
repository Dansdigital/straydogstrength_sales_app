...
export interface DefaultCopyViewDisplayText extends DefaultActionViewDisplayText<CopyHandlerData> {
    getListFoldersResultsMessage: (data: ListFoldersMessageData) => {
        content?: string;
        type?: MessageType;
    } | undefined;
...
export interface CreateFolderViewDisplayText extends Partial<DefaultCreateFolderViewDisplayText> {
}
export interface CopyViewDisplayText extends Partial<DefaultCopyViewDisplayText> {
}
